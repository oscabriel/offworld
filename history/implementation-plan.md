...
export const RepoInputSchema = z.string().describe(
...
const OFFWORLD_API = process.env.OFFWORLD_API_URL 
  ?? "https://offworld.convex.site/api";
...
export const router = os.router({
  clone: os
    ...
    .input(
      z.tuple([
        RepoNameSchema.describe("Repository (owner/repo)"),
        CloneOptionsSchema,
      ])
    )
    .handler(async ({ input }) => {
...
*Pattern sources: `create-better-t-stack`, `research/stolen-patterns.md`*
