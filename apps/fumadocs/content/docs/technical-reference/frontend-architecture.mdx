...
For detailed authentication patterns, see [Authentication & Data Loading](/technical-reference/auth-data-loading).
...
- Read [Authentication](/technical-reference/auth-data-loading) for auth patterns
