	...
	"commands": [
		{
			...
			"arguments": [
				{
					"name": "repo",
					"description": "Repository (owner/repo) or '.' for cwd",
					"required": true
				}
			],
			"options": [
		...
		},
		{
			...
			"arguments": [{ "name": "repo", "description": "Repository (owner/repo)", "required": true }]
		},
		{
			"name": "generate",
...
_Draft: January 2026_
_Audit added: January 8, 2026_
_All decisions resolved: January 8, 2026_
