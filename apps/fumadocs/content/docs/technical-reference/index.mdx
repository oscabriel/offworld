...
<Cards>
  <Card
    ...
    href="/docs/technical-reference/frontend-architecture"
  />
  <Card
    title="Backend Architecture"
    description="Convex functions, workflows, and schema"
    href="/docs/technical-reference/backend-architecture"
  />
  <Card
    title="AI & RAG System"
    description="Embeddings, prompts, and validation"
    href="/docs/technical-reference/ai-rag-system"
  />
  <Card
    title="API Reference"
    description="All Convex queries, mutations, and actions"
    href="/docs/technical-reference/api-reference"
  />
  <Card
    title="Environment Variables"
    description="Complete env var reference"
    href="/docs/technical-reference/environment-variables"
  />
</Cards>
...
### Auth
- **Better Auth v1** - Modern auth framework
...
- **Building features?** → [Developer Guide](/docs/developer-guide)
- **Setting up locally?** → [Project Setup](/docs/developer-guide/setup)
- **Understanding workflows?** → [Backend Architecture](/docs/technical-reference/backend-architecture)
