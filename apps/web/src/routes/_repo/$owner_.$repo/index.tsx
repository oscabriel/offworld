...
function RepoAnalysisPage() {
		...
		return (
			<div className="flex flex-1 flex-col">
				<div className="container mx-auto max-w-7xl flex-1 px-5 py-8 lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl">
					<ContentCard>
						<div className="bg-muted h-12 w-48 animate-pulse" />
						<div className="bg-muted mt-5 h-6 w-32 animate-pulse" />
					</ContentCard>
				</div>
			</div>
		);
	...
	if (!analysis) {
		return (
			<div className="flex flex-1 flex-col">
				<div className="container mx-auto max-w-7xl flex-1 px-5 py-8 lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl">
					<ContentCard title="No Skill Yet">
						<p className="text-muted-foreground mb-5 font-serif text-lg leading-relaxed">
							No skill exists for this repository yet. Generate one locally using the Offworld CLI:
						</p>
						<div className="border-primary/20 bg-background/50 mb-5 border p-5 font-mono text-sm">
			...
			<div className="container mx-auto max-w-7xl flex-1 px-5 py-8 lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl">
				<div className="space-y-8">
					...
					<ContentCard title="Install Skill">
						<p className="text-muted-foreground mb-5 font-serif text-lg leading-relaxed">
							Use this command to install the skill to all your AI coding agents:
						</p>
						<div className="border-primary/20 bg-background/50 mb-5 border p-5 font-mono text-sm">
							bunx offworld pull {fullName}
						</div>
