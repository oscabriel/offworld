	...
	return (
		<div className="space-y-5">
			...
			<div className="text-muted-foreground space-y-5 font-serif text-lg leading-relaxed">
				<p>
					<span className="text-primary mr-1.5">On-demand generation</span> Skills created from
				...
				<p>
					...
					“Analyze” agent is dedicated to being a fast and thorough learner and skill-writer.
				</p>
				<p>
					<span className="text-primary mr-1.5">Focused context</span> Use{" "}
					<code className="text-primary/90 text-sm">project init</code> to add only skills for your
					current project, rather than a pile of global skills.
				</p>
				<p>
