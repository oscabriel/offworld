...
const WORKOS_CLIENT_ID = process.env.WORKOS_CLIENT_ID ?? "client_XXXXX"; // Replace with actual
 ...
 */
async function pollForToken(deviceCode: string): Promise<TokenResponse | TokenErrorResponse> {
...
export async function authLoginHandler(): Promise<AuthLoginResult> {
	...
	p.log.info(`Or go to https://authkit.workos.com/device and enter: ${user_code}\n`);
