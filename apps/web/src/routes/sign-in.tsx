	...
	return (
		<div className="flex min-h-full flex-1 items-center justify-center p-8">
			<div className="w-full max-w-xl">
				<div className="border-border bg-card space-y-8 border p-13">
					<h1 className="text-center font-serif text-5xl font-normal">Welcome to Offworld</h1>

					<div className="flex justify-center">
						<a href={signInUrl}>
							<Button className="w-xs py-5" size="lg">
								<svg
									className="size-5"
									viewBox="0 0 24 24"
									fill="currentColor"
