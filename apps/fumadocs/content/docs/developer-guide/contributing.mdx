...
2. **Clone your fork**:
   ...
   ```
3. **Follow [Project Setup](/developer-guide/setup)** to get running locally
4. **Create a branch**:
   ```bash
...
2. **Run quality checks**:
   ...
   ```
3. **Test manually** (see [Development Workflow](/developer-guide/development-workflow))
...
Currently **manual testing** (see [Development Workflow](/developer-guide/development-workflow)).
...
- Check [Troubleshooting](/developer-guide/troubleshooting) if you encounter issues
- Read [Technical Reference](/technical-reference) for API details
