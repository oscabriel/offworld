...
export function RepoHeader({
	...
	return (
		<header className="border-primary/10 border-b">
			<div className="container mx-auto max-w-7xl px-5 py-5 lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl">
				<div className="space-y-2">
					...
					<div className="text-muted-foreground flex flex-wrap items-center gap-5 font-mono text-sm">
						{hasAnalysis && (
							<>
								<span className="bg-green-500/10 px-2 py-0.5 text-green-500">Analyzed</span>
						...
						{!hasAnalysis && (
							<span className="bg-yellow-500/10 px-2 py-0.5 text-yellow-600">Not Analyzed</span>
						)}
